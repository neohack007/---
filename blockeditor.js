...
helplines = new Array(
 ...
 "Исходный код: &lt;pre class = &gt;source_html&lt; &gt;текст&lt;/pre&gt;",
...
function showIcons () {
 ...
 for (i=0; i<l; i+=2) {
  ...
  document.writeln ('<img src="/tags/'+tagname+'.gif" width="18" height="18" hspace="0" vspace="0" alt="'+alter+'" title="'+alter+'"  onClick="bbstyle('+i+')" onMouseOver="helpline('+i2+')" onMouseOut="helpline(-1)">');
